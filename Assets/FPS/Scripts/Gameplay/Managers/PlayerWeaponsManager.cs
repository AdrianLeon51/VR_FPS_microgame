...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerWeaponsManager : MonoBehaviour
    {
        ...
        VRPlayerInputHandler m_InputHandler;
        ...
        void Start()
        {
            ...
            m_InputHandler = GetComponent<VRPlayerInputHandler>();
        ...
        public bool AddWeapon(WeaponController weaponPrefab)
        {
            ...
            for (int i = 0; i < m_WeaponSlots.Length; i++)
            {
                ...
                if (m_WeaponSlots[i] == null)
                {
                    ...
                    Transform parent = WeaponCamera != null ? WeaponCamera.transform : WeaponParentSocket;
                    WeaponController weaponInstance = Instantiate(weaponPrefab, parent);
